...
export class ConfigService {
  ...
  get mail() {
    return {
      host: this.getRequired('MAIL_HOST'),
      port: this.getRequired('MAIL_PORT'),
      user: this.getRequired('MAIL_USER'),
      pass: this.getRequired('MAIL_PASSWORD'),
      secure: this.getRequired('MAIL_SECURE').toLowerCase() === 'true',
      from: this.getRequired('MAIL_FROM'),
    };
  }
}
